...
/**
 * Re-port to J2ME, Removing code depending on processing
 * By Arjo Chakravarty
 *
...
public class Bluetooth implements DiscoveryListener, Runnable {
   ...
   public Bluetooth(HelloMIDlet midlet) {
        this(midlet, UUID_DEFAULT);
    }

    public Bluetooth(HelloMIDlet midlet, String id) {
        this.midlet = midlet;
        devices = new Vector();
        services = new Vector();
        try {
    ...
    public Bluetooth(HelloMIDlet midlet, long id) {
        this.midlet = midlet;
        devices = new Vector();
        services = new Vector();
        try {
